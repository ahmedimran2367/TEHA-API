// <copyright file="SmokeDetectorRequest.cs" company="PlaceholderCompany">
...
namespace TEHA.Portal.Data.Models.Order
{
    ...
    /// <summary>
    /// Details for Smoke detector test service to TEHA.
    /// </summary>
    public class SmokeDetectorRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets Meter Ids to request Smoke Detector test for.
        /// </summary>
